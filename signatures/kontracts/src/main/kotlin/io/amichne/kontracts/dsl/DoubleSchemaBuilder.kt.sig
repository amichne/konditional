...
type=io.amichne.kontracts.dsl.DoubleSchemaBuilder|kind=class|decl=open class DoubleSchemaBuilder @PublishedApi internal constructor() : JsonSchemaBuilder<Double>
fields:
- var title: String?
