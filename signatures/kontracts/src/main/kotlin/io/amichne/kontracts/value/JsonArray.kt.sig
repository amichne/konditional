...
type=io.amichne.kontracts.value.JsonArray|kind=class|decl=data class JsonArray( val elements: List<JsonValue>, val elementSchema: JsonSchema<Any>? = null, ) : JsonValue
fields:
- val size: Int get()
methods:
