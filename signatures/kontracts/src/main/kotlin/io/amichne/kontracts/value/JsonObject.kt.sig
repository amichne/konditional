...
type=io.amichne.kontracts.value.JsonObject|kind=class|decl=data class JsonObject( val fields: Map<String, JsonValue>, val schema: ObjectSchema? = null, ) : JsonValue
methods:
