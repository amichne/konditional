...
type=io.amichne.konditional.internal.serialization.adapters.FlagValueParts|kind=class|decl=private data class FlagValueParts( val type: String?, val value: Any?, val enumClassName: String?, val dataClassName: String?, val konstrainedClassName: String?, )
fields:
