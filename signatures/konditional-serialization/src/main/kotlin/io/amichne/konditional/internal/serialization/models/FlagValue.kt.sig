...
imports=com.squareup.moshi.JsonClass,io.amichne.konditional.api.KonditionalInternalApi,io.amichne.konditional.core.ValueType,io.amichne.konditional.core.types.Konstrained,io.amichne.konditional.core.types.asObjectSchema,io.amichne.konditional.serialization.SchemaValueCodec,io.amichne.konditional.serialization.internal.toJsonValue,io.amichne.konditional.serialization.internal.toPrimitiveMap,io.amichne.kontracts.dsl.jsonObject,io.amichne.kontracts.schema.ObjectSchema,io.amichne.kontracts.schema.ObjectTraits,io.amichne.kontracts.value.JsonArray,io.amichne.kontracts.value.JsonBoolean,io.amichne.kontracts.value.JsonNumber,io.amichne.kontracts.value.JsonObject,io.amichne.kontracts.value.JsonString,io.amichne.kontracts.value.JsonValue,kotlin.reflect.KClass
...
type=io.amichne.konditional.internal.serialization.models.KonstrainedPrimitive|kind=class|decl=data class KonstrainedPrimitive( override val value: Any, val konstrainedClassName: String, ) : FlagValue<Any>()
fields:
- abstract val value: T
methods:
- abstract fun toValueType(): ValueType @JsonClass(generateAdapter = true)
- fun validate(schema: ObjectSchema)
- fun <V : Any> extractValue( expectedSample: Any? = null, schema: ObjectSchema? = null, ): V
