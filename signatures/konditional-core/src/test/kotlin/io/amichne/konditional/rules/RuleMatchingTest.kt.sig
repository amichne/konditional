...
imports=io.amichne.konditional.context.AppLocale,io.amichne.konditional.context.Context,io.amichne.konditional.context.Platform,io.amichne.konditional.context.RampUp,io.amichne.konditional.context.Version,io.amichne.konditional.core.id.StableId,io.amichne.konditional.fixtures.core.id.TestStableId,io.amichne.konditional.fixtures.utilities.localeIds,io.amichne.konditional.fixtures.utilities.platformIds,io.amichne.konditional.rules.targeting.Targeting,io.amichne.konditional.rules.versions.FullyBound,io.amichne.konditional.rules.versions.Unbounded,kotlin.test.Test,kotlin.test.assertEquals,kotlin.test.assertFalse,kotlin.test.assertTrue
...
- private fun rule( rampUp: RampUp = RampUp.MAX, locales: Set<String> = emptySet(), platforms: Set<String> = emptySet(), versionRange: io.amichne.konditional.rules.versions.VersionRange = Unbounded, note: String? = null, ): Rule<Context>
