...
type=io.amichne.konditional.dimensions.ImplicitEnvironment|kind=enum|decl=private enum class ImplicitEnvironment(override val id: String) : AxisValue<ImplicitEnvironment>
