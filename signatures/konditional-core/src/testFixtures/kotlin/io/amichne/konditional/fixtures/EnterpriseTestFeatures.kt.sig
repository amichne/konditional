...
imports=io.amichne.konditional.context.AppLocale,io.amichne.konditional.context.Context,io.amichne.konditional.context.Platform,io.amichne.konditional.context.Version,io.amichne.konditional.core.Namespace,io.amichne.konditional.core.id.StableId,io.amichne.konditional.rules.evaluable.Predicate
...
type=io.amichne.konditional.fixtures.EnterpriseRule|kind=class|decl=data class EnterpriseRule( val requiredTier: SubscriptionTier? = null, val requiredRole: UserRole? = null, ) : Predicate<EnterpriseContext>
fields:
