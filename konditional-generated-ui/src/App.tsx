...
import PrimitivesColors from "./pages/primitives/Colors";
import PrimitivesTypography from "./pages/primitives/Typography";
import ComponentsInputs from "./pages/components/Inputs";
import SchemaFormsPage from "./pages/patterns/SchemaForms";
