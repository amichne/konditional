 ...
 */
private enum class SingleFlagModule : Module<Context> {
    TEST_MODULE {
 ...
 */
private enum class TwoFlagsModule : Module<Context> {
    TEST_MODULE {
        override fun flags(): Set<Conditional<*, *, Context>> = setOf(
            SampleFeatureEnum.ENABLE_COMPACT_CARDS,
 ...
 */
private enum class ThreeFlagsModule : Module<Context> {
    TEST_MODULE {
        override fun flags(): Set<Conditional<*, *, Context>> = setOf(
            SampleFeatureEnum.ENABLE_COMPACT_CARDS,
            SampleFeatureEnum.USE_LIGHTWEIGHT_HOME,
 ...
 */
private enum class VersionedFlagModule : Module<Context> {
    TEST_MODULE {
        override fun flags(): Set<Conditional<*, *, Context>> = setOf(
 ...
 */
private enum class FiftyFiftyModule : Module<Context> {
    TEST_MODULE {
        override fun flags(): Set<Conditional<*, *, Context>> = setOf(
