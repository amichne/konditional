...
fun <S : EncodableValue<T>, T : Any, C : Context, M : FeatureModule> C.evaluate(
    key: Feature<S, T, C, M>
): T {
...
/**
 * Evaluates all feature flags from a specific featureModule in the context of this [Context].
 *
 * This extension function evaluates every flag in the featureModule's registry and returns
 * a map of the results. Flags that don't match the context type will have
 * null values in the resulting map.
 *
 * @param module The featureModule whose flags should be evaluated
 ...
 * @param C The type of the context
 * @param M The featureModule type
 */
@Suppress("UNCHECKED_CAST")
fun <C : Context, M : FeatureModule> C.evaluateModule(module: M): Map<Feature<*, *, *, *>, Any?> =
