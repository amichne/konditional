 ...
 * - [ModuleSnapshotSerializer]: Serializes a single featureModule's configuration
 *
 * ## Usage Example
 *
 * ```kotlin
 * val serializer: Serializer<Konfig> = ModuleSnapshotSerializer(FeatureModule.Team.Payments)
 *
 * // Serialize to JSON
