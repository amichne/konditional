...
internal sealed class FlagValue<out T : Any> {
    ...
    companion object {
        ...
        fun from(value: Any): FlagValue<*> = when (value) {
            ...
            is io.amichne.konditional.core.types.CustomEncodeable<*> -> {
                // Convert custom encodeable to map representation
                @Suppress("UNCHECKED_CAST")
                val customEncodeable = value as io.amichne.konditional.core.types.CustomEncodeable<io.amichne.konditional.core.types.json.JsonSchema.ObjectSchema>
                ...
                "Supported types: Boolean, String, Int, Double, Enum, CustomEncodeable."
            )
        }
    }
}
