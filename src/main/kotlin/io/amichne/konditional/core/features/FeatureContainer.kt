...
// * kontextFn.evaluateSafe(PaymentFeatures.APPLE_PAY)
// * ```
// *
// * @param M The namespace type this features belongs to (e.g., Namespace.Payments)
// */
//abstract class FeatureContainer<M : Namespace>() : FeatureAware<M> {
//    companion object;
//
////    companion object {
////        inline fun <reified C : Kontext, M : Namespace> create(
////            namespace: M,
////            block: FeatureContainer<M>.() -> Unit,
////        ): FeatureContainer<M> = object : FeatureContainer<M>(namespace) {}.apply(block)
////    }
////    <out C : Kontext>(private val kontextFactory: () -> C)
////internal abstract class SearchFeatures<out C : Kontext>(private val kontextFactory: () -> C) : FeatureContainer<Namespace.Search>(
////    Namespace.Search
////), KontextAware<C> {
...
//     */
//    protected fun <C : Kontext<M>> boolean(
//        default: Boolean,
//        flagScope: FlagScope<EncodableValue<Boolean>, Boolean, C, M>.() -> Unit = {},
//    ): ReadOnlyProperty<FeatureContainer<M>, Feature<EncodableValue<Boolean>, Boolean, C, M>> =
...
//     */
//    protected fun <C : Kontext<*>> string(
//        default: String,
//        stringScope: FlagScope<StringEncodeable, String, C, M>.() -> Unit = {},
//    ): ReadOnlyProperty<FeatureContainer<M>, StringFeature<out C, M>> =
...
//     */
//    protected fun <C : Kontext<M>> integer(
//        default: Int,
...
//     */
//    protected fun <C : Kontext<*>> double(
//        default: Double,
...
//     */
//    protected fun <E : Enum<E>, C : Kontext<T : Namespace>> enum(
//        default: E,
...
//     */
//    protected inline fun <reified T : DataClassWithSchema, C : Kontext<T : Namespace>> dataClass(
//        default: T,
...
//    inner class ContainerFeaturePropertyDelegate<F : Feature<S, T, C, M>, S : EncodableValue<T>, T : Any, C : Kontext<T : Namespace>>(
