 ...
 */
sealed interface EnumFeature<E : Enum<E>, C : Kontext<M>, M : Namespace> :
    Feature<EnumEncodeable<E>, E, C, M> {

    companion object {
        internal operator fun <E : Enum<E>, C : Kontext<M>, M : Namespace> invoke(
            key: String,
            module: M,
        ): EnumFeature<E, C, M> =
        ...
        @PublishedApi
        internal data class EnumFeatureImpl<E : Enum<E>, C : Kontext<M>, M : Namespace>(
