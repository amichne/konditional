 ...
 */
fun <S : EncodableValue<T>, T : Any, C : Kontext<M>, M : Namespace> Feature<S, T, C, M>.evaluate(
    kontext: C,
    registry: NamespaceRegistry = namespace
): T = registry.flag(this).evaluate(kontext)
 ...
 */
internal fun <S : EncodableValue<T>, T : Any, C : Kontext<M>, M : Namespace> Feature<S, T, C, M>.update(
