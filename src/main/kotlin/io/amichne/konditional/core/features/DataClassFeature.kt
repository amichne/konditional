 ...
 * [CustomEncodeable] types. Consider using the term "custom feature" in new documentation.
 *
 * Example:
 * ```kotlin
 * @ConfigDataClass
 ...
 * ```
 *
 * @param T The custom type implementing [CustomEncodeable]<[JsonSchema.ObjectSchema]>
 * @param C The context type used for evaluation
 * @param M The namespace this feature belongs to
 */
sealed interface DataClassFeature<T : CustomEncodeable<JsonSchema.ObjectSchema>, C : Context, M : Namespace> :
    ...
    companion object {
         ...
         */
        operator fun <T : CustomEncodeable<JsonSchema.ObjectSchema>, C : Context, M : Namespace> invoke(
            key: String,
            module: M,
        ...
        @PublishedApi
        internal data class DataClassFeatureImpl<T : CustomEncodeable<JsonSchema.ObjectSchema>, C : Context, M : Namespace>(
