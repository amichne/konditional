...
type=io.amichne.kontracts.dsl.custom.CustomStringSchemaBuilder|kind=class|decl=class CustomStringSchemaBuilder<V : Any> @PublishedApi internal constructor() : StringSchemaBuilder()
fields:
