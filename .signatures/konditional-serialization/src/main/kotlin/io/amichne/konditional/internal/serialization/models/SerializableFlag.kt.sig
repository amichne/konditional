...
methods:
- fun toFlagPair( featuresById: Map<FeatureId, Feature<*, *, *>> = emptyMap(), ): ParseResult<Pair<Feature<*, *, *>, FlagDefinition<*, *, *>>>
- private fun resolveFeature( featuresById: Map<FeatureId, Feature<*, *, *>>, ): ParseResult<Feature<*, *, *>>
