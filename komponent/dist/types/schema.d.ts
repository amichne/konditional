...
export type VersionRange = VersionRangeUnbounded | VersionRangeMinBound | VersionRangeMaxBound | VersionRangeMinAndMaxBound;
...
export type FlagValue = BooleanFlagValue | StringFlagValue | IntFlagValue | DoubleFlagValue | EnumFlagValue | DataClassFlagValue;
...
export type Flag = BooleanFlag | StringFlag | IntFlag | DoubleFlag | EnumFlag | DataClassFlag;
...
export declare function generateSchemaFromSnapshot(snapshot: Snapshot): SchemaMetadata;
 ...
 */
export type AppLocale = 'AUSTRALIA' | 'AUSTRIA' | 'BELGIUM_DUTCH' | 'BELGIUM_FRENCH' | 'CANADA' | 'CANADA_FRENCH' | 'FINLAND' | 'FRANCE' | 'GERMANY' | 'HONG_KONG' | 'HONG_KONG_ENGLISH' | 'INDIA' | 'ITALY' | 'JAPAN' | 'MEXICO' | 'NETHERLANDS' | 'NEW_ZEALAND' | 'NORWAY' | 'SINGAPORE' | 'SPAIN' | 'SWEDEN' | 'TAIWAN' | 'UNITED_KINGDOM' | 'UNITED_STATES' | 'ICC_EN_EU' | 'ICC_EN_EI';
export declare const APP_LOCALES: readonly AppLocale[];
/**
 * Supported platforms.
 */
export type Platform = 'IOS' | 'ANDROID' | 'WEB';
export declare const PLATFORMS: readonly Platform[];
export declare function isBooleanFlag(flag: Flag): flag is BooleanFlag;
export declare function isStringFlag(flag: Flag): flag is StringFlag;
export declare function isIntFlag(flag: Flag): flag is IntFlag;
export declare function isDoubleFlag(flag: Flag): flag is DoubleFlag;
export declare function isEnumFlag(flag: Flag): flag is EnumFlag;
export declare function isDataClassFlag(flag: Flag): flag is DataClassFlag;
...
export declare function parseFeatureId(id: FeatureId): ParsedFeatureId | null;
export declare function formatFeatureId(namespace: string, key: string): FeatureId;
export {};
