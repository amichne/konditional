...
konditionalPublishing {
    artifactId.set("rest-spec")
    moduleName.set("Konditional REST Spec")
    moduleDescription.set("Framework-agnostic REST surface contracts and OpenAPI generation for Konditional server integrations")
}
