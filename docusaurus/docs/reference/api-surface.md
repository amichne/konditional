...
| `CLM-PR01-11A` | `method` | `io.amichne.konditional.serialization.snapshot.NamespaceSnapshotLoader#override fun load( json: String, options: SnapshotLoadOptions, ): Result<MaterializedConfiguration>` | [/quickstart/load-first-snapshot-safely.md](/quickstart/load-first-snapshot-safely.md) | [/quickstart/load-first-snapshot-safely.md](/quickstart/load-first-snapshot-safely.md) |
