...
The <TypeAnnotation type="Feature<Theme, Context, Namespace>" description="Compile-time feature type inferred from the delegate.">theme</TypeAnnotation>
property is statically typed, and <TypeAnnotation type="Theme" description="Non-null because a default value is required.">evaluate(ctx)</TypeAnnotation>
returns a non-null `Theme` at compile time.
