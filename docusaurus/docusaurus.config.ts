        ...
        navbar: {
            ...
            items: [
                ...
                },
                {
                    ...
                    position: 'left',
                    items: [
                        {type: 'doc', docId: 'advanced/recipes/index', label: 'Recipes: Best-Practice Patterns'},
                        {type: 'doc', docId: 'advanced/recipes/typed-variants', label: 'Typed Variants'},
                        {type: 'doc', docId: 'advanced/recipes/rampup', label: 'Deterministic Ramp-Up'},
                        {type: 'doc', docId: 'advanced/recipes/reset', label: 'Restart Ramp-Up Sample'},
                        {type: 'doc', docId: 'advanced/recipes/axes', label: 'Runtime Axes'},
                        {type: 'doc', docId: 'advanced/recipes/extension', label: 'Business Logic Targeting'},
                        {type: 'doc', docId: 'advanced/recipes/structured', label: 'Structured Values'},
                        {type: 'doc', docId: 'advanced/recipes/load', label: 'Safe Remote Load'},
                        {type: 'doc', docId: 'advanced/recipes/rollback', label: 'Rollback Config'},
                        {type: 'doc', docId: 'advanced/recipes/shadow', label: 'Shadow Evaluation'},
                        {type: 'doc', docId: 'advanced/recipes/namespace', label: 'Namespace Isolation'},
                        {type: 'doc', docId: 'advanced/recipes/observability', label: 'Observability Hooks'},
                    ],
                },
