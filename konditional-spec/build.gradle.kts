...
konditionalPublishing {
    artifactId.set("konditional-spec")
    moduleName.set("Konditional Spec")
    moduleDescription.set("Framework-agnostic REST surface contracts and OpenAPI generation for Konditional")
}
