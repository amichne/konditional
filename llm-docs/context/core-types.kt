...
# Extracted: 2026-02-08T06:47:34+00:00
...
konditional-core/src/main/kotlin/io/amichne/konditional/rules/RuleValue.kt:10:sealed interface RuleValue<out T : Any, in C : Context> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleScope.kt:41:interface RuleScope<C : Context> : ContextRuleScope<C>,
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleDslExtensions.kt:23:fun <T : Any, C : Context, M : Namespace> FlagScope<T, C, M>.ruleScoped(
...
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:198:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateInternalApi(
