...
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:33:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluate(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:61:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.explain(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:71:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateWithReason(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:197:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateInternalApi(
...
konditional-core/src/main/kotlin/io/amichne/konditional/context/Context.kt:37:interface Context {
konditional-core/src/main/kotlin/io/amichne/konditional/internal/KonditionalInternalApi.kt:26:annotation class KonditionalInternalApi
...
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:24:data class SerializedFlagDefinitionMetadata(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:32:data class SerializedFlagRuleSpec<T : Any>(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:44:fun <T : Any, C : Context, M : Namespace> flagDefinitionFromSerialized(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:74:fun FlagDefinition<*, *, *>.toSerializedMetadata(): SerializedFlagDefinitionMetadata =
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:82:fun FlagDefinition<*, *, *>.toSerializedRules(): List<SerializedFlagRuleSpec<Any>> =
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:37:interface YieldingScopeHost {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:44:class PendingYieldToken internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:64:fun <C : Context> FlagScope<Boolean, C>.enable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:67:fun <C : Context> FlagScope<Boolean, C>.disable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/context/axis/Axis.kt:47:abstract class Axis<T>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/internal/builders/FlagBuilder.kt:34:data class FlagBuilder<T : Any, C : Context, M : Namespace>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleScope.kt:36:interface RuleScope<C : Context> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/FlagDefinition.kt:28:data class FlagDefinition<T : Any, C : Context, M : Namespace>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/result/ParseResult.kt:45:fun <T> ParseResult<T>.getOrThrow(): T = when (this) {
...
konditional-runtime/src/main/kotlin/io/amichne/konditional/runtime/NamespaceOperations.kt:15:fun Namespace.load(configuration: ConfigurationView) {
konditional-runtime/src/main/kotlin/io/amichne/konditional/runtime/NamespaceOperations.kt:19:fun Namespace.rollback(steps: Int = 1): Boolean =
konditional-runtime/src/main/kotlin/io/amichne/konditional/serialization/snapshot/NamespaceSnapshotLoader.kt:17:class NamespaceSnapshotLoader<M : Namespace>(
konditional-runtime/src/main/kotlin/io/amichne/konditional/core/registry/InMemoryNamespaceRegistry.kt:28:class InMemoryNamespaceRegistry(
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/internal/serialization/adapters/FlagValueAdapter.kt:110:object FlagValueAdapterFactory : JsonAdapter.Factory {
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/internal/serialization/models/FlagValue.kt:32:sealed class FlagValue<out T : Any> {
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/serialization/instance/ConfigurationDiff.kt:16:data class ConfigurationDiff internal constructor(
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/serialization/instance/ConfigValue.kt:10:sealed interface ConfigValue {
konditional-serialization/src/main/kotlin/io/amichne/konditional/serialization/snapshot/ConfigurationSnapshotCodec.kt:52:object ConfigurationSnapshotCodec : SnapshotCodec<Configuration> {
