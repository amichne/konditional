...
# Extracted: 2026-02-07T09:41:47+00:00
...
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:13:sealed interface Ref<T : Any, C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:48:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.bind(): Ref<T, C> = FeatureRef(this)
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:57:inline fun <reified T : Any, reified C : Context, M : Namespace> Feature<T, C, M>.asRef(): Ref<T, C> =
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:63:inline fun <reified T : Any, reified C : Context, M : Namespace, R : Any> Feature<T, C, M>.map(
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:70:inline fun <reified T : Any, reified C : Context, M : Namespace, R : Any> Feature<T, C, M>.flatMap(
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:77:inline fun <reified T : Any, reified C : Context, M : Namespace, R : Any> Feature<T, C, M>.thenUse(
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:84:inline fun <reified T : Any, reified C : Context, M : Namespace, R : Any> Feature<T, C, M>.zip(
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:91:inline fun <reified T : Any, reified C : Context, M : Namespace, R : Any> Feature<T, C, M>.zip(
konditional-core/src/main/kotlin/io/amichne/konditional/api/Ref.kt:98:inline fun <reified T : Any, reified C : Context, M : Namespace, D : Context> Feature<T, C, M>.contraMapContext(
konditional-core/src/main/kotlin/io/amichne/konditional/api/CompositeEvaluationResult.kt:9:data class CompositeEvaluationResult<T : Any>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/types/ObjectSchemaConversions.kt:10:fun JsonSchema<*>.asObjectSchema(): ObjectSchema =
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/serialization/SchemaValueCodec.kt:28:object SchemaValueCodec {
...
kontracts/src/main/kotlin/io/amichne/kontracts/dsl/ReflectiveObjectSchemaBuilder.kt:10:class ReflectiveObjectSchemaBuilder<T : Any>(
kontracts/src/main/kotlin/io/amichne/kontracts/dsl/ReflectiveObjectSchemaBuilder.kt:82:inline fun <reified T : Any> reflectiveSchema(
...
kontracts/src/main/kotlin/io/amichne/kontracts/schema/ReflectiveObjectSchema.kt:12:data class ReflectiveObjectSchema<T : Any>(
...
kontracts/src/main/kotlin/io/amichne/kontracts/schema/ReflectiveFieldSchema.kt:11:data class ReflectiveFieldSchema<T : Any, out V>(
