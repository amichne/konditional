...
# Extracted: 2026-02-09T03:00:36-05:00
# Source: modules/*/src/main/kotlin

# Module: konditional-core
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:35:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluate(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:43:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluate(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:71:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.explain(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:79:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.explain(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluationDeprecated.kt:16:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateWithReason(
...
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluationSupport.kt:66:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateInternalApi(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/registry/EvaluationSnapshot.kt:19:interface EvaluationSnapshot {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/FlagScope.kt:34:interface FlagScope<T : Any, C : Context, out M : Namespace> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/rules/RuleValue.kt:5:sealed interface RuleValue<out T : Any, in C : Context> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/registry/NamespaceRegistry.kt:81:interface NamespaceRegistryRuntime : NamespaceRegistry {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/FlagDefinition.kt:30:data class FlagDefinition<T : Any, C : Context, M : Namespace>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSetBuilder.kt:9:class RuleSetBuilder<T : Any, C : Context> @PublishedApi internal constructor() {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSpec.kt:16:data class RuleSpec<out T : Any, in C : Context> @PublishedApi internal constructor(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleScope.kt:40:interface RuleScope<C : Context> : ContextRuleScope<C>,
...
konditional-runtime/src/main/kotlin/io/amichne/konditional/core/registry/InMemoryNamespaceRegistry.kt:31:class InMemoryNamespaceRegistry(
