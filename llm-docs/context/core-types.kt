...
# Extracted: 2026-02-10T23:34:32-05:00
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSpec.kt:15:data class RuleSpec<out T : Any, in C : Context> @PublishedApi internal constructor(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSetBuilder.kt:8:class RuleSetBuilder<T : Any, C : Context> @PublishedApi internal constructor() {
...
kontracts/src/main/kotlin/io/amichne/kontracts/dsl/JsonSchemaBuilders.kt:194:fun schema(builder: RootObjectSchemaBuilder.() -> Unit): ObjectSchema =
kontracts/src/main/kotlin/io/amichne/kontracts/dsl/JsonSchemaBuilders.kt:197:fun schemaRef(ref: String): JsonSchema<Any> = JsonSchema.ref(ref)
...
kontracts/src/main/kotlin/io/amichne/kontracts/schema/RefSchema.kt:6:data class RefSchema(
