...
# Extracted: 2026-02-08T12:18:27+00:00
# Source: modules/*/src/main/kotlin

# Module: konditional-core
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:26:data class SerializedFlagDefinitionMetadata(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:34:data class SerializedFlagRuleSpec<T : Any>(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:46:fun <T : Any, C : Context, M : Namespace> flagDefinitionFromSerialized(
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:76:fun FlagDefinition<*, *, *>.toSerializedMetadata(): SerializedFlagDefinitionMetadata =
konditional-core/src/main/kotlin/io/amichne/konditional/internal/FlagDefinitionInternal.kt:84:fun FlagDefinition<*, *, *>.toSerializedRules(): List<SerializedFlagRuleSpec<Any>> =
konditional-core/src/main/kotlin/io/amichne/konditional/rules/Rule.kt:66:data class Rule<in C : Context> internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/rules/RuleValue.kt:12:sealed interface RuleValue<out T : Any, in C : Context, M : Namespace> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/rules/versions/Unbounded.kt:6:data object Unbounded : VersionRange(Type.UNBOUNDED, MIN_VERSION, MAX_VERSION) {
...
konditional-core/src/main/kotlin/io/amichne/konditional/rules/ConditionalValue.kt:17:data class ConditionalValue<T : Any, C : Context, M : Namespace> private constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/rules/evaluable/Specifier.kt:3:interface Specifier {
konditional-core/src/main/kotlin/io/amichne/konditional/rules/evaluable/Placeholder.kt:5:data object Placeholder : Predicate<Context> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/evaluation/EvaluationScope.kt:18:class EvaluationScope<out C : Context, M : Namespace> internal constructor(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/FlagDefinition.kt:32:data class FlagDefinition<T : Any, C : Context, M : Namespace>(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSpec.kt:17:data class RuleSpec<out T : Any, in C : Context, M : Namespace> @PublishedApi internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/StableIdTargetingScope.kt:11:interface StableIdTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/AxisTargetingScope.kt:11:interface AxisTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/LocaleTargetingScope.kt:11:interface LocaleTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/ExtensionTargetingScope.kt:10:interface ExtensionTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/VersionTargetingScope.kt:11:interface VersionTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/targeting/scopes/PlatformTargetingScope.kt:12:interface PlatformTargetingScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/NoteScope.kt:10:interface NoteScope<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSetBuilder.kt:10:class RuleSetBuilder<T : Any, C : Context, M : Namespace> @PublishedApi internal constructor() {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/YieldingScopeHost.kt:6:interface YieldingScopeHost {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleScopeBase.kt:31:interface RuleScopeBase<C : Context> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/ContextRuleScope.kt:12:interface ContextRuleScope<C : Context> :
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/PendingYieldToken.kt:6:class PendingYieldToken internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleSet.kt:9:class RuleSet<RC : Context, T : Any, C, M : Namespace> @PublishedApi internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/rules/RuleScope.kt:43:interface RuleScope<C : Context> : ContextRuleScope<C>,
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleDslExtensions.kt:15:fun <T : Any, C : Context, M : Namespace> FlagScope<T, C, M>.rule(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleDslExtensions.kt:26:fun <T : Any, C : Context, M : Namespace> FlagScope<T, C, M>.ruleScoped(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/FlagScope.kt:38:interface FlagScope<T : Any, C : Context, out M : Namespace> {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/AxisValuesScope.kt:38:interface AxisValuesScope {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:27:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.enable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:37:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.disable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:47:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.enableScoped(build: ContextRuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:57:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.disableScoped(build: ContextRuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:67:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.ruleSet(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:82:fun <T : Any, C, M : Namespace, RC : Context> Feature<T, C, M>.ruleSet(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:97:inline fun <reified RC : Context, T : Any, C, M : Namespace> Feature<T, C, M>.ruleSet(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:116:inline fun <reified T> AxisValuesScope.axis(value: T) where T : AxisValue<T>, T : Enum<T> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/registry/NamespaceRegistry.kt:66:interface NamespaceRegistryRuntime : NamespaceRegistry {
...
konditional-core/src/main/kotlin/io/amichne/konditional/api/KonditionalInternalApi.kt:30:annotation class KonditionalInternalApi
...
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:34:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluate(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:62:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.explain(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:72:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateWithReason(
konditional-core/src/main/kotlin/io/amichne/konditional/api/FeatureEvaluation.kt:116:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateInternalApi(
konditional-core/src/main/kotlin/io/amichne/konditional/api/AxisUtilities.kt:21:inline fun <reified T> Context.axis(): Set<T> where T : AxisValue<T>, T : Enum<T> =
konditional-core/src/main/kotlin/io/amichne/konditional/api/AxisUtilities.kt:30:inline fun <reified T, reified C : Context> C.axis(axis: Axis<T>): Set<T> where T : AxisValue<T>, T : Enum<T> =
...
konditional-core/src/main/kotlin/io/amichne/konditional/context/axis/Axis.kt:52:class Axis<T> private constructor(
...
konditional-core/src/main/kotlin/io/amichne/konditional/context/axis/AxisDefinition.kt:22:open class AxisDefinition<T>(
...
konditional-serialization/src/main/kotlin/io/amichne/konditional/internal/serialization/adapters/VersionRangeAdapter.kt:28:class VersionRangeAdapter(moshi: Moshi) {
...
konditional-observability/src/main/kotlin/io/amichne/konditional/api/ShadowOptions.kt:4:data class ShadowOptions internal constructor(
konditional-observability/src/main/kotlin/io/amichne/konditional/api/ShadowMismatch.kt:4:data class ShadowMismatch<T : Any> internal constructor(
konditional-observability/src/main/kotlin/io/amichne/konditional/api/ShadowEvaluation.kt:20:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateWithShadow(
konditional-observability/src/main/kotlin/io/amichne/konditional/api/ShadowEvaluation.kt:67:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.evaluateShadow(
...
kontracts/src/main/kotlin/io/amichne/kontracts/schema/ValidationResult.kt:7:sealed class ValidationResult {
...
kontracts/src/main/kotlin/io/amichne/kontracts/value/JsonNull.kt:10:object JsonNull : JsonValue {
kontracts/src/main/kotlin/io/amichne/kontracts/value/JsonBoolean.kt:10:data class JsonBoolean(val value: Boolean) : JsonValue {
