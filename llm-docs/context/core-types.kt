...
# Extracted: 2026-02-04T23:12:50-05:00
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:21:class YieldingScope<T : Any, C : Context, out M : Namespace> internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:44:class ContextYieldingScope<T : Any, C : Context, out M : Namespace> internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:61:interface YieldingScopeHost {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:68:class PendingYieldToken internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:88:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.enable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:91:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.disable(build: RuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:97:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.enableScoped(build: ContextRuleScope<C>.() -> Unit = {}) =
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:100:fun <C : Context, M : Namespace> FlagScope<Boolean, C, M>.disableScoped(build: ContextRuleScope<C>.() -> Unit = {}) =
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:18:data class RuleSpec<out T : Any, in C : Context>(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:24:class RuleSet<RC : Context, T : Any, C, M : Namespace> @PublishedApi internal constructor(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:40:class RuleSetBuilder<T : Any, C : Context> @PublishedApi internal constructor() {
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:67:fun <T : Any, C : Context, M : Namespace> Feature<T, C, M>.ruleSet(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:73:fun <T : Any, C, M : Namespace, RC : Context> Feature<T, C, M>.ruleSet(
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleSet.kt:79:inline fun <reified RC : Context, T : Any, C, M : Namespace> Feature<T, C, M>.ruleSet(
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/FlagScope.kt:31:interface FlagScope<T : Any, C : Context, out M : Namespace> {
...
konditional-core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleScope.kt:246:interface RuleScope<C : Context> : ContextRuleScope<C>,
