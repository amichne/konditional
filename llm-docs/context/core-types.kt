...
# Extracted: 2026-01-05T21:49:12-05:00
...
core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:17:class YieldingScope<T : Any, C : Context> internal constructor(
core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:59:fun <C : Context> FlagScope<Boolean, C>.enable(build: RuleScope<C>.() -> Unit = {}) =
core/src/main/kotlin/io/amichne/konditional/core/dsl/DslSugar.kt:62:fun <C : Context> FlagScope<Boolean, C>.disable(build: RuleScope<C>.() -> Unit = {}) =
...
core/src/main/kotlin/io/amichne/konditional/core/dsl/RuleScope.kt:36:interface RuleScope<C : Context> {
