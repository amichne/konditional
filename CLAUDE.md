...
│   │   │   └── internal/        # SingletonModuleRegistry implementation
...
- `core/SingletonModuleRegistryTests.kt` - Registry behavior
- `core/StringSingletonModuleRegistryTest.kt` - String flag registry
- `core/ConditionalExtensibilityTest.kt` - Extension mechanisms
...
- `serialization/SnapshotSerializerTest.kt` - JSON serialization
- `serialization/SerializationExampleTest.kt` - Serialization examples
